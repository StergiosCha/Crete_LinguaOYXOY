...
- **Πείραμα Β (ερμηνεία):** https://stergioscha.github.io/Crete_LinguaOYXOY/?exp=b

**Πριν στείλετε τα links σε συμμετέχοντες**, κάντε μία φορά το κάθε πείραμα εσείς οι ίδιοι για να βεβαιωθείτε ότι όλα δουλεύουν σωστά (δημογραφικά → οδηγίες → εξάσκηση → βαθμολόγηση → τέλος) και ότι τα δεδομένα σας εμφανίζονται στο Google Sheet.
